...
\newcommand{\tenKL}{Nghiên cứu kĩ thuật co giãn tài nguyên đa cấp độ chủ động cho ứng dụng SmartHome trong môi trường điện toán đám mây}% Chú ý dấu   trong tên khóa luận
\newcommand{\tenKLU}{NGHIÊN CỨU KĨ THUẬT CO GIÃN TÀI NGUYÊN ĐA CẤP ĐỘ CHỦ ĐỘNG CHO ỨNG DỤNG SmartHome TRONG MÔI TRƯỜNG ĐIỆN TOÁN ĐÁM MÂY}% Chú ý dấu   trong tên khóa luận
